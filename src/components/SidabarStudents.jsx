...
import { Box, Text, Divider, ScrollArea, Image, } from "@mantine/core";
import { useNavigate, useLocation } from "react-router-dom";
import classes from "../../src/App.module.css";
import pic from "../routes/OtherLinks/StudentsLinks/Images/student_manual.jpg";
    ...
    >
      <div className={classes.root}>
        ...
        <div className={classes.links}>
          ...
          />
          {items}
          <Image maw={350} src={pic} p="md" style={{marginTop: "2rem"}}/>
        </div>
      </div>
    </div>
  );
